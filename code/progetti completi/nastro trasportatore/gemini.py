...
def dobot(coda_comunicazione,stop_event):
    ...
    punto_rossi = {"x": 70,"y": 201, "z": -85.5}
    punto_verdi = {"x": 10,"y": 201, "z": -85.5}
    punto_blu = {"x": -58,"y": 201, "z": -85.5}
    ...
    while conta < 6:
        ...
        dobotEdu.magician.set_ptpcmd(port_name, ptp_mode=0, x=punto_carico["x"], y=punto_carico["y"], z=punto_carico["z"]+40, r=20)
        ...
        dobotEdu.magician.set_ptpcmd(port_name, ptp_mode=0, x=punto_sensore["x"], y=punto_sensore["y"], z=punto_sensore["z"]+40, r=20)
