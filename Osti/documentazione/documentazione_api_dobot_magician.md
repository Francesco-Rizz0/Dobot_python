...
* logiche di attesa basate sul rilevamento oggetti ->
  ...
  ***while device.get_infrared_sensor(port=2) == 0:***
...
***maschera = cv2.inRange(hsv, lower_red, upper_rd)** # Isola i pixel rossi*;

* classificazione del cubetto ->
  
***pixel_colore = cv2.countNonZero(maschera)***
...
**allarmi_attivi = device.get_alarms()**
